<form method="post" class='chatgpt-ai'>
    ...
    <div class="d-flex align-items-center mt-3">
      <button type="submit" name='SUBMITFORM' class="btn btn-success btn-block btn-lg text-light mt-2 sendadminRequest"
      id='sendadminRequest'>Send Request</button>
